@r2 @trainers(v2) @positive @smoke @megan-davies @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(megan-davies)
    Given I send HTTP "GET" request to "v2/trainers/megan-davies" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/megan-davies.properties" properties file
