@r2 @trainers(v2) @positive @smoke @kathy-smith @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(kathy-smith)
    Given I send HTTP "GET" request to "v2/trainers/kathy-smith" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/kathy-smith.properties" properties file
