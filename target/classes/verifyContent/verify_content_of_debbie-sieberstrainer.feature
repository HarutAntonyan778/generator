@r2 @trainers(v2) @positive @smoke @debbie-siebers @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(debbie-siebers)
    Given I send HTTP "GET" request to "v2/trainers/debbie-siebers" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/debbie-siebers.properties" properties file
