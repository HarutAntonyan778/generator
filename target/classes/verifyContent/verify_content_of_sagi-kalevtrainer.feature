@r2 @trainers(v2) @positive @smoke @sagi-kalev @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(sagi-kalev)
    Given I send HTTP "GET" request to "v2/trainers/sagi-kalev" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/sagi-kalev.properties" properties file
