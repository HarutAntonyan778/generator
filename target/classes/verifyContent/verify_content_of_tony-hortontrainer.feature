@r2 @trainers(v2) @positive @smoke @tony-horton @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(tony-horton)
    Given I send HTTP "GET" request to "v2/trainers/tony-horton" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/tony-horton.properties" properties file
