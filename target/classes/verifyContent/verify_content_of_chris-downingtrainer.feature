@r2 @trainers(v2) @positive @smoke @chris-downing @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(chris-downing)
    Given I send HTTP "GET" request to "v2/trainers/chris-downing" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/chris-downing.properties" properties file
