@r2 @trainers(v2) @positive @smoke @chalene-johnson @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(chalene-johnson)
    Given I send HTTP "GET" request to "v2/trainers/chalene-johnson" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/chalene-johnson.properties" properties file
