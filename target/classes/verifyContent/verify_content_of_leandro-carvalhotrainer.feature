@r2 @trainers(v2) @positive @smoke @leandro-carvalho @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(leandro-carvalho)
    Given I send HTTP "GET" request to "v2/trainers/leandro-carvalho" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/leandro-carvalho.properties" properties file
