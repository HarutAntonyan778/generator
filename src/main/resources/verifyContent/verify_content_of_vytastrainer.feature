@r2 @trainers(v2) @positive @smoke @vytas @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(vytas)
    Given I send HTTP "GET" request to "v2/trainers/vytas" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/vytas.properties" properties file
