@r2 @trainers(v2) @positive @smoke @shaun-t @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(shaun-t)
    Given I send HTTP "GET" request to "v2/trainers/shaun-t" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/shaun-t.properties" properties file
