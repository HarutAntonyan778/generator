@r2 @trainers(v2) @positive @smoke @brett-hoebel @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(brett-hoebel)
    Given I send HTTP "GET" request to "v2/trainers/brett-hoebel" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/brett-hoebel.properties" properties file
