@r2 @trainers(v2) @positive @smoke @caley-alyssa @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(caley-alyssa)
    Given I send HTTP "GET" request to "v2/trainers/caley-alyssa" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/caley-alyssa.properties" properties file
