@r2 @trainers(v2) @positive @smoke @dr-cheng @validate_static_data
Feature: GET "v2/trainers" API test cases based on user scenarios
  ...
  @verify_content
  Scenario Outline: Verify GET Trainers API with trainer slug(dr-cheng)
    Given I send HTTP "GET" request to "v2/trainers/dr-cheng" API with headers
      | Accept | application/json |

    Then Read "resources/trainersContent/dr-cheng.properties" properties file
